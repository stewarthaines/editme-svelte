...
<div class="navigation-editor">
  <div class="editor-toolbar">
    <div class="editor-controls">
      <button 
        class="mode-button"
        class:active={isAutoGenerated}
        on:click={switchToAutoMode}
      >
        Auto-generate
      </button>
      <button 
    ...
    <div class="editor-actions">
      <button on:click={regenerateFromSpine}>
        Regenerate from Spine
      </button>
      <button on:click={saveNavigation}>
        Save
      </button>
    </div>
  </div>
      ...
      <div class="auto-toc-editor">
        <div class="toc-controls">
          <label>
            <input 
              type="checkbox" 
              bind:checked={includeAllHeadings}
              on:change={regenerateTOC}
            />
...
const extractHeadingsFromSpineItem = async (
  ...
  try {
    ...
    const headingElements = transformResult.xhtmlDocument.querySelectorAll('h1, h2, h3, h4, h5, h6')
...
const updatePreview = async (): Promise<void> => {
  ...
  try {
    ...
    const processedHTML = await blobURLManager.substituteResourceURLs(
      previewHTML,
      workspaceId
    )
