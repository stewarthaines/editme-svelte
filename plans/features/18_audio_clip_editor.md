    ...
    <div class="timeline-container">
      ...
      <div class="timeline-controls">
        ...
        <div class="clip-controls">
          <button on:click={setClipStart} disabled={!audioElement}>
            Set Start
          </button>
          <button on:click={setClipEnd} disabled={!audioElement}>
            Set End
          </button>
          <button on:click={clearClip} disabled={!hasClipRange}>
            Clear Clip
          </button>
        </div>
      </div>
    ...
    {#if hasClipRange}
      <div class="clip-info">
        ...
        <div class="clip-actions">
          <button on:click={playClip} class="primary">
            Play Clip
          </button>
          <button on:click={() => playLastSeconds(2)}>
            Last 2 Seconds
          </button>
          <button on:click={exportClip}>
            Export Clip Data
          </button>
        </div>
      </div>
