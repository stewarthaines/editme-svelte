...
describe('Text Editor Store', () => {
  ...
  describe('Factory Function - createTextEditorStore()', () => {
    describe('Valid Store Creation', () => {
      ...
      it.each(VALID_EDITOR_IDS)(
        'should create store with valid editor ID: %s',
        (editorId) => {
          const store = createTextEditorStore(editorId);
          expect(store).toBeDefined();
  ...
  describe('Store State Management', () => {
    ...
    describe('Initial State', () => {
      ...
      it('should have correct initial state with provided content', () => {
        const contentStore = createTextEditorStore(createUniqueEditorId(), SAMPLE_CONTENT.MEDIUM_TEXT);
    ...
    describe('isEmpty Derivation', () => {
      it('should set isEmpty to true for empty content', () => {
        ...
        const state = subscriberSpy.mock.calls[subscriberSpy.mock.calls.length - 1][0] as TextEditorState;
    ...
    describe('lastUpdated Timestamp', () => {
      it('should update timestamp when content changes', () => {
        ...
        const updatedState = subscriberSpy.mock.calls[subscriberSpy.mock.calls.length - 1][0] as TextEditorState;
  ...
  describe('Store Methods', () => {
    ...
    describe('updateContent()', () => {
      ...
      it.each(EDGE_CASE_CONTENT)(
        'should handle edge case content: %s',
    ...
    describe('Input Sanitization - Non-String Inputs', () => {
      it.each(INVALID_INPUTS)(
        'should ignore non-string input: %s (%s)',
        (_description, input) => {
          unsubscribeFunction = store.subscribe(subscriberSpy);
          const initialCallCount = subscriberSpy.mock.calls.length;
  ...
  describe('Performance and Edge Cases', () => {
    it('should handle rapid consecutive updates', () => {
      ...
      const finalState = subscriberSpy.mock.calls[subscriberSpy.mock.calls.length - 1][0] as TextEditorState;
