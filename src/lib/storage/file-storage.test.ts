	...
	describe('Storage Manager', () => {
		...
		describe('UUID Generation', () => {
			it('should generate valid workspace IDs', () => {
				const uuidPattern = /^workspace-[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/;
				
				// Test the UUID generation logic directly
				const testId = 'workspace-' + 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'.replace(/[xy]/g, function(c) {
