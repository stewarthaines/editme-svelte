...
export class ZipWriter {
	 ...
	 */
	async addFile(fileName: string, data: SupportedDataType, options: AddFileOptions = {}): Promise<ZipWriter> {
		const {
	 ...
	 */
	#createEndOfCentralDirectory(numEntries: number, centralDirSize: number, centralDirOffset: number): ArrayBuffer {
